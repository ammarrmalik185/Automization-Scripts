...
for x in range(1,100):
    if not os.path.isfile(r"Logs\log " + str(x) + ".txt"):
        file2 = open(r"Logs\log " + str(x) + ".txt","w")
        log_no = x
        break
...
def sorter():
    ...
    info = [r"D:\Animes\Watched Random Episodes",
            r"D:\Animes\Sorted Animes",
            r"Algorithums\horriable subs algo.txt"]
    ...
    file2.write("Source Folder : "+ info[0] + "\n")
    file2.write("Save Folder   : "+ info[1] + "\n")
    file2.write("Methord Used  : "+ info[2] + "\n")
    ...
    file2.write("\n Total files moved : " + str(moved) + " files")
    file2.write("\n Unable to move " + str(not_moved) + " files")
    file2.write("\n Folders made : " + str(folders_made) + " folders")
...
sorter()
input("Process complete ... log is available in Logs\log " + str(log_no) + ".txt ...press enter to exit ...")
